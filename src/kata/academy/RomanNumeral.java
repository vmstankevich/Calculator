...
enum RomanNumeral {
    ...
    XXXI(31), XXXII(32), XXXIII(33), XXXIV(34), XXXV(35), XXXVI(36), XXXVII(37), XXXVIII(38), XXXIX(39), XXXX(40),
    ...
    public static RomanNumeral getRoman(int value) {
        for (RomanNumeral s : values()) {
            if (s.getArabic() == value) {
               return s;
            }
        }
